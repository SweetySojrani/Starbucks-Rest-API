...
exports.product = function(req, res) {
  ...
  var productsData = [
      { _id: 0, name: "Coffee1", image_url: "menu1.png", description: "Good coffee",  price: 3.72, count: 3},
      { _id: 1, name: "Coffee2", image_url: "menu2.png", description: "Good coffee",  price: 4.32, count: 4 },
      { _id: 2, name: "Coffee3", image_url: "menu3.png", description: "Good coffee",  price: 5.534, count: 5 }
    ];
